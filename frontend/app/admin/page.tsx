...
export const metadata: Metadata = {
  title: "管理后台 - CareerPilot",
  description: "管理岗位数据、知识库、图谱和系统配置"
};
  ...
  return (
    <AppShell title="管理后台" subtitle="管理岗位数据、知识库、图谱、系统配置与调度任务，支撑比赛演示与后续产品化扩展。">
      ...
      <SectionCard title="调度监控">
        <ul className="plain-list">
          {jobs.map((job: { job_name: string; cron_expr: string; status: string; job_type: string }) => (
            <li key={job.job_name}>
