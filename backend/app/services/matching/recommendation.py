...
EXPERIENCE_KEYWORDS = [
    ...
    "财务", "金融", "投资", "审计", "税务", "会计", "估值",
    "法律", "法务", "合同", "合规", "知识产权",
    "市场", "营销", "品牌", "广告", "公关", "新媒体",
    "销售", "客户", "商务",
    "人力资源", "招聘", "薪酬", "绩效",
    "机械", "土木", "建筑", "电气", "化工", "AutoCAD",
    "医药", "临床", "生物", "药品", "食品",
    "供应链", "物流", "采购", "仓储",
    "教育", "培训", "教学", "课程",
    "咨询", "顾问", "战略",
...
TRACK_KEYWORDS: dict[str, tuple[str, ...]] = {
    ...
    "金融": ("金融", "财务", "投资", "估值", "会计", "审计", "银行", "基金", "证券", "保险", "精算", "风控"),
    "市场": ("市场", "营销", "品牌", "广告", "公关", "新媒体", "策划", "推广"),
    "销售": ("销售", "客户", "商务", "谈判", "crm"),
    "人力": ("人力资源", "招聘", "薪酬", "绩效", "培训", "组织"),
    "工程": ("机械", "土木", "建筑", "电气", "化工", "autocad", "结构", "施工", "工艺"),
    "教育": ("教育", "教学", "课程", "培训", "留学"),
    "法律": ("法律", "法务", "合同", "合规", "知识产权", "专利"),
    "医药": ("医药", "临床", "生物", "药品", "食品", "营养"),
    "物流": ("物流", "供应链", "采购", "仓储", "库存"),
    "传媒": ("新闻", "编辑", "记者", "视频", "动画", "设计", "视觉"),
    "咨询": ("咨询", "顾问", "战略", "管理咨询"),
    "外贸": ("翻译", "外贸", "跨境电商", "本地化"),
    "服务": ("酒店", "旅游", "餐饮", "物业"),
    "能源": ("能源", "新能源", "石油", "储能", "环保"),
...
def _resume_relevance(ocr: dict, job_profile: JobProfile) -> float:
    ...
    for token in ("数据分析", "数据处理", "后端开发", "算法", "人工智能", "前端开发", "产品",
                  "金融分析", "财务会计", "市场营销", "机械设计", "土木工程", "建筑设计",
                  "医药代表", "人力资源", "供应链", "教育培训", "法务合规", "项目管理"):
